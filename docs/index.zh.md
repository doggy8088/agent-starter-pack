...
hero:
  ...
  text: 在 Google Cloud 上更快地建構生產級 AI 代理
  tagline: 透過預建模板與工具，更快地從想法轉為部署。
  image:
...
features:
  - icon: ⚡️
    title: 快速啟動
    details: 透過實作常見模式的預建代理模板（ReAct、RAG、多代理、即時多模態 API）快速開始。
  - icon: 🧪
    title: 實驗與評估
    details: 使用整合的 Vertex AI 評估和互動式測試場域進行迭代。
  - icon: ☁️
    title: 自信部署
    details: 透過具備監控、可觀察性和 CI/CD 功能的生產級基礎設施（Cloud Run / Agent Engine）部署可靠的代理。
  - icon: 🛠️
    title: 客製化與擴展
    details: 根據您的特定使用案例調整和增強模板與基礎設施。
---

::: tip ⭐ 喜歡 Agent Starter Pack 嗎？
透過在 GitHub 上給予我們一個星標，幫助我們傳播。
...
- **新使用者：** [開始使用指南](/guide/getting-started)
- **設定：** [安裝指南](/guide/installation)
- **上線：** [部署指南](/guide/deployment)
- **探索模板：** [代理模板概覽](/agents/overview)
- **命令列：** [CLI 參考](/cli/)